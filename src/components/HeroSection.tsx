  ...
  return <section className="relative min-h-screen flex items-center bg-background diagonal-texture overflow-hidden">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="max-w-4xl">
          {/* Title */}
          <h1 className="font-syncopate text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-foreground leading-tight mb-6 tracking-wider">PROJETO E OBRA PARA UMA EXPERIÊNCIA MAIS LEVE</h1>
